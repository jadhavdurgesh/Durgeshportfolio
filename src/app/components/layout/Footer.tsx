      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            >
              Flutter, React Native, and Android (Kotlin and Jetpack Compose) developer building production ready mobile apps. Turning bold ideas into polished digital products.
            </p>
        ...
        >
          ...
          >
            Built with <Heart size={12} color="#ec4899" fill="#ec4899" /> in Flutter, React Native & Kotlin
          </p>
        </div>
      </div>
    </footer>
